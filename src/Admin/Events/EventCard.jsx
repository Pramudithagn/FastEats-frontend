      ...
      <Card sx={{ width: 345 }}>
        ...
        <CardContent>
          ...
          <div className="py-2 space-y-2">
            ...
            <p className="text-sm text-blue-500">{dayjs(item.startedAt).format("MMMM DD, YYYY hh:mm A")}</p>
            <p className="text-sm text-red-500">{dayjs(item.endsAt).format("MMMM DD, YYYY hh:mm A")}</p>
          </div>
        </CardContent>
        {!isCustomer && (
          <CardActions>
