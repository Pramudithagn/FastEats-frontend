...
import React, { useEffect, useState } from 'react';
import { Box, Button, Grid, Modal, TextField, CircularProgress, IconButton } from '@mui/material';
import { useDispatch, useSelector } from 'react-redux';
import { createEventAction, getRestaurnatsEvents } from '../../components/state/restaurant/Action';
import { useParams } from 'react-router-dom';
import { DateTimePicker, LocalizationProvider } from '@mui/x-date-pickers';
...
const validationSchema = Yup.object({
  ...
  endsAt: Yup.date()
    ...
    .min(Yup.ref('startedAt'), 'End date and time must be after start date and time')
    .nullable(),
});
